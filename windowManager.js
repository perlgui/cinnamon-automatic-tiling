...
const WindowTiling = imports.ui.windowTiling;
...
var WindowManager = class WindowManager {
    ...
    constructor() {
        ...
        this._tiling = new WindowTiling.WindowTiling(this, this.wm_settings);
    ...
    _mapWindow(cinnamonwm, actor) {
        ...
        if (this.wm_settings.get_boolean('auto-tile') &&
            actor._windowType === Meta.WindowType.NORMAL &&
            !actor.meta_window.is_skip_taskbar() &&
            this._tiling._canAutoTileWindow(actor.meta_window, { w: 400, h: 300 })) {
            actor._autoTilePendingMap = true;
            this._tiling.suppressBorder(); 
            actor.opacity = 0;
            actor.show();
    ...
    _destroyWindowDone(cinnamonwm, actor) {
        if (this._destroying.delete(actor)) {
            ...
            this._tiling.onWindowDestroyed();
        }
    }
